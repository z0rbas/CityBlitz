...
agent_communication:
  ...
  - agent: "main"
    message: "Implemented enhanced Playwright-based scraping for JavaScript-heavy sites. The new scraper tries basic scraping first, then uses browser automation if few businesses are found. This should handle South Tampa Chamber and similar dynamic content sites. Ready for testing with the specific problematic URL."